...
def main():
    ...
    template = open('Fasta/SARS2-NTD.fa', 'r').readlines()[0].rstrip()
    cassettes = range(0,36,1) #cassettes = range(0,N,1), where N is the number of cassattes needed
    F_output_file = 'primer/SARS2-NTD_lib_Fprimer_bc.fa'
    R_output_file = 'primer/SARS2-NTD_lib_Rprimer_bc.fa'
